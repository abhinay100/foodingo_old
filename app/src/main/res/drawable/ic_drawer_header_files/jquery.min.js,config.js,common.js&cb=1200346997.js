...
define('be/buttons',[ "jquery", "be/spinner", "hgn!templates/form/loadingMessage" ], function(a, b, c) {
    "use strict";
    function d(b) {
    ...
    function e(d, e) {
        e = e || "Saving...";
        var g = d.find(".form-submit-processing");
        return d.find(".form-button").hide().each(function() {
            var b = a(this).parent();
            b.hasClass("form-item-a") && b.hide();
        }), d.addClass("button-arrow-none"), g.length ? void g.html(e) : (d.append(c({
            message: e
        })), b.create(d.find(".js-spin")[0], f), d.find(".spinner").css({
            left: "10px",
            top: "11px",
            width: "23px",
            height: "23px",
...
define('be/history',{
    ...
    replaceState: function() {
        this.supportsReplaceState() && window.history.replaceState.apply(window.history, arguments);
    }
});
            ...
            return a.cookielessRedirect() ? !1 : (window.adobeid = {
                ...
                onReady: function() {
                    if (e) {
                        ...
                        return "undefined" == typeof f[d.QS_IMS_SSO_INBOUND] ? void a.reloadPage() : b.supportsReplaceState() ? (b.replaceState({}, document.title, window.location.pathname), 
                        void a.reloadPage()) : void (c.getLocation().search = "");
                    }
                }
            }, !0);
        },
