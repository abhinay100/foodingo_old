...
public class DishFavAdapter extends ArrayAdapter<Dish> implements Filterable {
    ...
    public DishFavAdapter(Context context, List<Dish> objects) {
        super(context, layout.row_favdish_adapter, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(layout.row_favdish_adapter,
                    null);
        }
